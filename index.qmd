...
#| eval: false
#| warning: false
#| label: Creación de la población fundadora, creación del objeto de clase SimParam (SP) e importación de efectos de QTLs.
...
#| eval: true
#| warning: false
#| label: Observación de la varianza genética aditiva de la población base.
...
#| eval: true
#| warning: false
#| label: Observación de la media fenotípica de la población base.
...
#| eval: true
#| warning: false
#| label: Observación de la varianza fenotípica de la población base.
...
#| eval: true
#| warning: false
#| label: Observación de los valores mejorantes de la población mejorada.
#| fig.width: 6
#| fig.height: 6

ggplot(data = as_tibble(gv(gen1)), mapping = aes(x = Agregado_PD)) +
...
#| eval: true
#| warning: false
#| label: Observación de la varianza genética aditiva de la población mejorada.
...
#| eval: true
#| warning: false
#| label: Observación de la media fenotípica de la población mejorada.
...
#| eval: true
#| warning: false
#| label: Observación de la varianza fenotípica de la población mejorada.
...
tibble(
  ...
  `Réplica 1` = c(-21.23, 324.83, 1157.24, -0.02, 23.50, 167.65, 1003.59, 44.27, 0.42, 0.001),
  `Réplica 2` = c(21.46, 368.89, 1325.58, -0.02, 69.02, 159.97, 1129.03, 47.15, 0.41, 0.001),
  `Réplica 3` = c(-6.87, 349.98, 1260.77, -0.02, 40.19, 183.42, 1093.02, 47.33, 0.41, 0.001),
  `Réplica 4` = c(-35.26, 463.50, 1644.34, -0.02, 18.06, 221.36, 1457.38, 54.42, 0.40, 0.0003),
  `Réplica 5` = c(23.80, 417.07, 1478.78, -0.02, 72.48, 221.50, 1317.98, 50.16, 0.43, 0.001),
  `Réplica 6` = c(22.38, 465.94, 1672.25, -0.02, 75.72, 226.46, 1456.74, 53.77, 0.40, 0.001),
  `Réplica 7` = c(-8.23, 534.73, 1910.08, -0.02, 47.55, 275.29, 1640.63, 55.87, 0.38, 0.001),
  `Réplica 8` = c(-24.75, 290.86, 1035.77, -0.02, 20.02, 171.85, 902.35, 43.64, 0.43, 0.001),
  `Réplica 9` = c(-10.17, 316.38, 1125.35, -0.02, 34.05, 172.43, 1007.28, 44.53, 0.42, 0.001),
  `Réplica 10` = c(-19.43, 392.42, 1411.05, -0.02, 29.33, 200.64, 1184.29, 48.16, 0.42, 0.001)
  ) |>
