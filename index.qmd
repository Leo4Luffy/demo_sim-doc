...
gen1@pheno <- gen1@pheno + 1000 # Se suma un valor de 1000 (media o intercepto) a todos los fenotipos después de haberlos simulado, para así evitar valores fenotípicos negativos.
...
La varianza genética aditiva de la población base es igual a ```r round(var(ebv_blupf90), digits = 2)```.
